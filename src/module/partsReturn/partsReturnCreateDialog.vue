<template>
  <div class="partsReturn">
    <el-dialog :title="$t('new_srv_partsreturnline')" :visible="visible" :before-close="beforeClose" size="large">
      ...
      <el-table stripe :data="tableData" v-loading="loading" ref="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="new_srv_changeorder_idName" label="转换单号">
        </el-table-column>
    ...
    initData: function() {
     ...
     /* if (this.queryForm.startDate != "") {
      ...
      var params = {
        ...
        //isfailureparts:this.isFailureParts=='2'?1:2
      };
     
      //旧件类型
     switch(this.isFailureParts)
     {
       case 1:
       {
          params["isfailureparts"]=2;
       }
       break;
       case 2:
       {
          params["isfailureparts"]=1;
       }
       break;
       case 3:
       {
         params["isfailureparts"]=3;
       }
       break;
       case 4:
       {
         params["isfailureparts"]=4;
       }
       break;
     }
