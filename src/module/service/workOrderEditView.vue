  ...
  <div id="orderEdit">
    <rt-header :title="$t('new_srv_workorder')">
      <rt-toolbar showBack @goback="beforeGoBack">
        <rt-button type="add" @click="gotoAddPage()"  v-if="canEdit"/>
        <rt-button  type="save" @click="SaveData('editForm')"  v-if="canEdit" />
        <rt-button  type="btnsingle" @click="orderTakeWorkOrder()"  v-if="canEdit" />
        <rt-button  type="btnslip" @click="slipWorkOrderVerify()"  v-if="canEdit" />
        <rt-button  type="btndispatch" @click="dispatchWorkOrder()"   v-if="canEdit"/>
        <!-- <rt-button type="submit" @click="onSave('editForm')" /> -->
        <rt-button  type="btncompleted" @click="confirmWorkOrderVerify()"  v-if="canEdit" />
        <rt-button  text="技术支持-提交" type="submit" @click="techSubmit()"  v-if="canEdit"/>
        <rt-button  text="虚假单申诉" type="submit" @click="complain()"  v-if="canEdit"/>
      </rt-toolbar>
    </rt-header>
    ...
    <rt-content>
      ...
      <rt-nav slot="side" ref="_rt_nav">
        ...
        <!-- <rt-nav-item href="#area2">客户信息</rt-nav-item> -->
        <!-- <rt-nav-item href="#area3">产品信息</rt-nav-item> -->
        ...
        <rt-nav-item href="#area10" v-if="editForm.new_type!=4&&isEditForm&&editForm.new_type!=16&&editForm.new_type!=17&&editForm.new_type!=10">配件申请</rt-nav-item>
        <!-- <rt-nav-item href="#area11">上门鉴定</rt-nav-item>
        <rt-nav-item href="#area12">上门设计</rt-nav-item> -->
      ...
      <el-form ref="editForm" :model="editForm" :rules="rules" label-width="120px" label-position="left">
        <rt-section id="area1" title="基本信息">
          ...
          <el-row :gutter="50">
            ...
            <el-col :span="16">
              <el-form-item label="服务现场地址" prop="new_complateaddress">
          ...
          <el-row :gutter="50">
             ...
             <el-col :span="8">
              <el-form-item label="购买单位类型" prop="new_channeltype" :rules="editForm.new_type!=5?[{ type:'number',required: true, message: '', trigger: 'change'}]:[]">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_channeltype" entity="new_srv_workorder" attribute="new_channeltype" :disabled="isEditForm&&!isReceipt&&!isNeedReceipt"></rt-picklist> -->
              </el-form-item>
            </el-col>
             <el-col :span="8">
              <el-form-item label="处理级别" prop="new_deallevel">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_deallevel" entity="new_srv_workorder" attribute="new_deallevel" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="特殊类型" prop="new_speicaltype">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_speicaltype" entity="new_srv_workorder" attribute="new_speicaltype" :disabled="isEditForm"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="预约上门时间段" prop="new_timequantum">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_timequantum" entity="new_srv_workorder" attribute="new_timequantum" :disabled="isEditForm&&!isReceipt"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
            ...
            <el-col :span="8">
              <el-form-item label="VIP等级" prop="new_viplevel">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_viplevel" entity="new_srv_workorder" attribute="new_viplevel" :disabled="isEditForm"></rt-picklist> -->
              </el-form-item>
            </el-col>
             <el-col :span="8">
              <el-form-item label="服务项目" prop="new_serviceitem">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_serviceitem" entity="new_srv_workorder" attribute="new_serviceitem" :disabled="isEditForm"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
          ...
          <el-row :gutter="50">
             <el-col :span="8">
              <el-form-item label="受理人" prop="new_systemuser_id">
                <el-input v-model="editForm.new_systemuser_idName" readonly @keyup.enter.native="quickSystemuser" :disabled="true" icon="search"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="受理日期" prop="new_accepttime">
                <el-date-picker v-model="editForm.new_accepttime" :editable="false" :disabled="true" class="rt-portal-item-date" type="datetime" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
             <el-col :span="8">
              <el-form-item label="负责人" prop="owneridName">
                <el-input v-model="editForm.owneridName" readonly :disabled="true" icon="search"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
          ...
          <el-row :gutter="50">
            <el-col :span="24">
              <el-form-item label="故障排查">
                <el-input type="textarea" v-model="editForm.new_analyze" :disabled="isEditForm"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="产品型号" prop="new_productmodel_idName">
          ...
          <el-row :gutter="50">
            ...
            <el-col :span="8">
              <el-form-item label="安装日期" prop="new_installdate" :rules="editForm.new_type==4&&isCompleteWorkOrder? ruleRequireDate:null">
                <el-date-picker v-model="editForm.new_installdate" :editable="false" :disabled="(isEditForm&&!isReceipt)||editForm.new_type!=4" class="rt-portal-item-date" type="date" placeholder="选择日期" ></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
            <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="客户姓名" v-if = false>
                <el-input v-model="editForm.new_accountname" :disabled="isEditForm"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
             ...
             <el-col :span="8">
              <el-form-item label="气源类型" prop="new_airsupply" v-if="this.editForm.new_type==16" >
    ...
    <el-col :span="8">
        ...
        <rt-section id="areaProcess" title="处理过程跟进" v-if="isEditForm">
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="处理阶段">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_dealstage" entity="new_srv_workorder" attribute="new_dealstage" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="处理状态">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_dealstatus" entity="new_srv_workorder" attribute="new_dealstatus" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row :gutter="50">
            ...
            <el-col :span="8">
              <el-form-item label="服务商电话">
                <el-input v-model="editForm.new_station_tel" :disabled="isEditForm"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="接单/转单时间">
                <el-date-picker v-model="editForm.new_responsetime" :editable="false" :disabled="isEditForm" class="rt-portal-item-date" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="派工时间">
                <el-date-picker v-model="editForm.new_dispatchtime" :editable="false" :disabled="isEditForm" class="rt-portal-item-date" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="工程师接单时间">
                <el-date-picker v-model="editForm.new_begintime" :editable="false" :disabled="isEditForm" class="rt-portal-item-date" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="预约时间-日期">
            ...
            <el-col :span="8">
              <el-form-item label="工程师预约上门时间节点">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_engineer_appointmenttime" entity="new_srv_workorder" attribute="new_engineer_appointmenttime" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
          ...
          <el-row :gutter="50">
            ...
            <el-col :span="8">
              <el-form-item label="信管跟单">
                <el-checkbox v-model="editForm.new_isdocumentary3" :disabled="isEditForm"></el-checkbox>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="改派原因" prop="new_reassignment" :rules="isSlipWorkOrder?ruleRequireNumber:null">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_reassignment" entity="new_srv_workorder" attribute="new_reassignment" :disabled="!isNeedReceipt"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
            ...
            <el-col :span="8">
              <el-form-item label="中心完工结果">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_auditcentrality" entity="new_srv_workorder" attribute="new_auditcentrality" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="总部完工结果">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_audithq" entity="new_srv_workorder" attribute="new_audithq" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
          ...
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="超期原因" prop="new_overduereasons" :rules="isCompleteWorkOrder&&editForm.new_servicelength1>24?ruleRequireNumber:null">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_overduereasons" entity="new_srv_workorder" attribute="new_overduereasons" :disabled="isEditForm&&!isReceipt"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="网点跟单">
                <el-checkbox v-model="editForm.new_isdocumentary1" :disabled="isEditForm"></el-checkbox>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="中心跟单">
                <el-checkbox v-model="editForm.new_isdocumentary2" :disabled="isEditForm"></el-checkbox>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="中心回访建议">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_rvisitadvise1" entity="new_srv_workorder" attribute="new_rvisitadvise1" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="总部回访建议">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_rvisitadvise2" entity="new_srv_workorder" attribute="new_rvisitadvise2" :disabled="true"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="用户满意度" prop="new_csi" :rules="isCompleteWorkOrder?ruleRequireNumber:null">
                <el-select v-model="editForm.new_csi" clearable :disabled="isEditForm&&!isReceipt">
                  <el-option v-for="item in pickListOptions['new_csi']" :key="item.Value" :label="item.Text" :value="item.Value">
                    {{item.Text}}
                  </el-option>
                </el-select>
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_csi" entity="new_srv_workorder" attribute="new_csi" :disabled="isEditForm&&!isReceipt"></rt-picklist> -->
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
            ...
            <el-col :span="8">
              <el-form-item label="服务次数">
                <el-input v-model.number="editForm.new_servicetimes" :disabled="isEditForm"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
        ...
        <rt-section id="areaResult" title="处理结果" v-if="isEditForm&&editForm.new_type!=16&&editForm.new_type!=17">
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="回访状态">
                ...
                <!-- <rt-picklist :options="pickListOptions" :hasOptions="true" v-model="editForm.new_status" entity="new_srv_workorder" attribute="new_status" :disabled="isEditForm"></rt-picklist> -->
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row :gutter="50">
            <el-col :span="16">
              <el-form-item label="技术支持审核意见" prop="new_tech_memo">
                <el-input type="textarea" v-model="editForm.new_tech_memo" disabled="disabled"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="50">
          ...
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="安装数量" prop="new_installqty">
                <el-input v-model.number="editForm.new_installqty" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="保内数量" prop="new_inwarranty_qty">
                <el-input v-model.number="editForm.new_inwarranty_qty" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="保外数量" prop="new_outwarranty_qty">
                <el-input v-model.number="editForm.new_outwarranty_qty" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row  :gutter="50">
            ...
            <el-col :span="16">
              <el-form-item label="申诉理由" prop="new_complain_memo">
                <el-input type="textarea" v-model="editForm.new_complain_memo" :disabled="this.editForm.new_unrealstatus!=1"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </rt-section>
      ...
      <div v-if="showComponents_1">
        <!--服务工程师-->
        <OutsideLineModel ref="outsideLineModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" v-if="isEditForm"></OutsideLineModel>
        <!-- 套机产品明细 -->
        <WorkOrder2UserprofileModel ref="WorkOrder2UserprofileModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_type:this.editForm.new_type,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,new_purchase_date:this.editForm.new_purchase_date,canEdit:this.canEdit}" @gotoNewOrder="gotoNewOrder" v-if="isEditForm&&this.editForm.new_type!=10&&this.editForm.new_type!=16&&this.editForm.new_type!=17"></WorkOrder2UserprofileModel>
      </div>
      <div v-if="showComponents_2&&editForm.new_type!=10">
        <!-- 故障明细 -->
        <troubleModel :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,new_tech_approvalstatus:this.editForm.new_tech_approvalstatus,canEdit:this.canEdit}" v-if="editForm.new_type!=4&&isEditForm&&editForm.new_type!=16&&editForm.new_type!=17"></troubleModel>
        <!-- 换件明细 -->
        <partLineModel ref="partLineModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,new_tech_approvalstatus:this.editForm.new_tech_approvalstatus,canEdit:this.canEdit}" @reLoad="reloadPartsApply" v-if="editForm.new_type!=4&&isEditForm&&editForm.new_type!=16&&editForm.new_type!=17"></partLineModel>
      </div>            
      <div v-if="editForm.new_type==10">
        <areaInfoModel :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" @reload="reloadAreaInfo"></areaInfoModel>
        <insideInfoModel ref="insideInfoModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" @reLoad="reloadOutSideInfo"></insideInfoModel>
        <outsideInfoModel ref="outsideInfoModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" @reLoad="reloadInSideInfo"></outsideInfoModel>
        <!--上门设计-->
        <!-- <visitDesignView :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp}"></visitDesignView> -->
      </div>
      <div v-if="showComponents_3">
        <!--服务互动-->
        <InteractionModel ref="interactionModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" v-if="isEditForm"></InteractionModel>
        <!-- 配件申请 -->
        <partsapplyModel ref="partsapplyModel" :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" v-if="editForm.new_type!=4&&isEditForm&&editForm.new_type!=10&&editForm.new_type!=16&&editForm.new_type!=17"></partsapplyModel>
      ...
      <div v-if="showComponents_4">
        ...
        <!--修改记录-->
        <workorderLogModel :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp}" v-if="isEditForm&&canEdit"></workorderLogModel>
        <!--附件-->
        <attachment :workOrder="{id:this.new_srv_workorderid,name:this.editForm.new_name,new_dealstage:this.editForm.new_dealstage,usedApp:this.usedApp,canEdit:this.canEdit}" v-if="isEditForm"></attachment>
      </div>
...
export default {
  ...
  methods: {
    ...
    getPickListOptions() {
      ...
      var attributes3 = "new_holedirection,new_holesize,new_unrealstatus";
        ...
        rt.get(requestStr)
          .then(res => {
            ...
            var requestStr =
              ...
              "&entityName=new_srv_station&attributeList=new_usedapp,new_level";
            rt.get(requestStr)
              .then(function(res) {
                ...
                for (var k in array) {
                  ...
                  if (array[k].Key == "new_level" && array[k].Value == 2) {
                    that.canEdit = false;
                  }
                }
