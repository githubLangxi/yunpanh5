...
export default {
  ...
  methods: {
    ...
    search: function() {
      ...
      this.lookupOptions = [
        { label: "故障现象编码", name: "new_code" },
        { label: "故障名称", name: "new_name" }
      ];
      var params = {
      ...
      var lookupQueryStr = "/api/WorkOrder/CrmLookupError";
      this.loading = true;
      let that = this;
      rt
        ...
        .then(function(res) {
          ...
          that.dialogtableData = data.errorModel; //将obj添加到数据集
          that.loading = false;
        })
        .catch(error => {
