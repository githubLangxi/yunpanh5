...
export default {
  ...
  methods: {
    ...
    show: function() {
      ...
      this.lookupOptions = [{ label: this.$t('new_srv_worker.new_name'), name: 'new_name' }, { label: this.$t('new_srv_worker.new_phone'), name: 'new_phone' }]
      var params = {
        entityName: 'new_srv_worker',
        attributeList: 'new_name,new_phone',
        pageIndex: this.currentPage,
        pageSize: this.pageSize,
        IsActive: true,
        filterList: 'new_srv_station_id=' + this.shipConfirmid
      }
    ...
    lookupSelect: function() {
      ...
      this.$emit("lookupSelect", this.currentRow.new_id, this.currentRow.new_name, this.currentRow.new_phone);
    },
    //lookup的页面尺寸变更
