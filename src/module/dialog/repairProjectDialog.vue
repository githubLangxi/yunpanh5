...
export default {
    ...
    methods: {
        ...
        show: function(ev) {
            ...
            this.lookupOptions = [{ label: this.$t('MaintenanceProjectName'), name: 'new_name' }]
            var params = {
                entityName: 'new_srv_project',
                attributeList: 'new_name',
        ...
        lookupSelect: function() {
            ...
            this.$emit('lookupSelect', this.currentRow.new_id, this.currentRow.new_name);
        },
        //lookup的页面尺寸变更
