  ...
  methods: {
    ...
    fetchRecords: function() {
      if (this.rectificationid) {
        this.loading = true;
        var requestStr = '../api/WorkOrder/Annotation/' + this.rectificationid;
      ...
      else
      {
        ...
        reader.onload = function(f) {
          ...
          if (file.size >= _this.fileAutoSize) {
            ...
            annotation["id"] = id;
            annotation["entityname"] = "new_rectification";
    ...
    //上传附件
    uploadFile: function() {
     if (rt.isNullOrWhiteSpace(this.rectificationid)) {
         this.$message({
          type: "warning",
          message: "请先保存主档"
        })
